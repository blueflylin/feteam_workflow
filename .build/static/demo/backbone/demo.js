 ...
 */
define("static/demo/backbone/demo", [ "underscore", "backbone", "willkan/backbone-localStorage/1.1.6/backbone.localStorage" ], function(require) {
    var _ = require("underscore"), Backbone = require("backbone");
    require("willkan/backbone-localStorage/1.1.6/backbone.localStorage");
    console.log("backbone demo here");
    var id = new Date().valueOf(), $box = $("<div/>").attr("id", "box" + id), $demo = $("<div/>").attr("id", "demo" + id).css({
        width: 100
    });
